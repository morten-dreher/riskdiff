...
The true type I error rate of this test is thus $0.0324$ and the resulting test will be conservative, which is not surprising for a discrete test.
...
From above, we learned that our test rejects for risk differences of 0.66 or greater (or for risk differences truly greater than 0.5).
